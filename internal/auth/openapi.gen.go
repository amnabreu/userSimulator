...
type ServerInterface interface {
	...
	// Get a team
	// (GET /auth/teams/{slug})
	GetTeam(ctx echo.Context, slug string) error
	// Add a user to a team
	// (POST /auth/teams/{slug}/users)
	AddUserToTeam(ctx echo.Context, slug string) error
}
...
func (w *ServerInterfaceWrapper) GetTeam(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.GetTeam(ctx, slug)
	return err
}
...
func (w *ServerInterfaceWrapper) AddUserToTeam(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshalled arguments
	err = w.Handler.AddUserToTeam(ctx, slug)
	return err
}
